...
[ "$PROVIDER_VERSION" = "11.3.0" ] || block v11_provider_resolution_mismatch
...
EXPECTED_API_COMMIT="$(printf '%s%s' '00f60b8792a1962b88d4' '0377114724c61f276062')"
jq -e --arg api_commit "$EXPECTED_API_COMMIT" '
  .contract_id == "f5xc-smsv2-api/v1" and
  .contract_version == "7.0.0" and
  .api_release_tag == "v8.0.2" and
