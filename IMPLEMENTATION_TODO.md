...
- [x] Pin provider v10.1.0 for the Site-UID image resolver, template/JWT contract, and mutation HTTP/1 ALPN fix.
- [x] Reconcile the existing AWS showcase owner: the #1194 state root remains authoritative; #1210 starts with an empty backend.
- [x] Repair stale CI policy and contract tests for v10.1.0 and obsolete KVM bootstrap semantics.
