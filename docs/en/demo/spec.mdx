...
- **Providers**:
  - `f5-sales-demo/xcsh` (`= 11.0.2`): `api_url` is dynamically derived from `var.expected_xc_tenant` (`https://${var.expected_xc_tenant}.console.ves.volterra.io`).
