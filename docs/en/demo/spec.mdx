...
- **Providers**:
  - `f5-sales-demo/xcsh` (`= 10.1.0`): `api_url` is dynamically derived from `var.expected_xc_tenant` (`https://${var.expected_xc_tenant}.console.ves.volterra.io`).
