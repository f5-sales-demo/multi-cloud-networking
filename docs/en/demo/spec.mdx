...
- **Providers**:
  - `f5-sales-demo/xcsh` (`= 11.0.0`): `api_url` is dynamically derived from `var.expected_xc_tenant` (`https://${var.expected_xc_tenant}.console.ves.volterra.io`).
